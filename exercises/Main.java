...
/*public class Main {
    ...
    public static void putWordsTogether(SLL<String> lista) {
        ...
        //SLLNode<String> newword = null;
        //SLLNode<String> node1;
        
        while(temp != null) {
            if(letter(temp.element)) {
               word.append(temp.element);
            } 
            else  {
                lista.delete(temp);
                //temp.element = word.toString();
               // list.insertLast(word.toString());
            }
            //list.insertLast(word.toString());
            temp = temp.succ;
        }
